 ...
 * AEP Apex Trigger Name: ${AEP_Apex_Trigger_Name_eg_OpportunityAepTrigger} <br>
 * Existing AEP Apex TriggerHandler Name: ${Existing_AEP_Apex_TriggerHandler_Name_eg_OpportunitiesAepTriggerHandler}
 */

trigger ${AEP_Apex_Trigger_Name_eg_OpportunityAepTrigger} on ${SObject_API_Name_eg_Opportunity} (
